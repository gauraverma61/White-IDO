...
export interface ParioPrivatePoolInterface extends utils.Interface {
  functions: {
...
export interface ParioPrivatePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ParioPrivatePoolInterface;
