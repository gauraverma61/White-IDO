...
export interface ParioPoolFactoryInterface extends utils.Interface {
  functions: {
    ...
    "setIsEnabled(bool)": FunctionFragment;
  ...
  events: {
    ...
    "PresaleEnabled(bool,bool)": EventFragment;
...
export interface PresaleEnabledEventObject {
  _old: boolean;
  _new: boolean;
}
export type PresaleEnabledEvent = TypedEvent<
  [boolean, boolean],
  PresaleEnabledEventObject
>;
...
export interface ParioPoolFactory extends BaseContract {
  ...
  filters: {
    ...
    "PresaleEnabled(bool,bool)"(
      _old?: null,
      _new?: null
    ): PresaleEnabledEventFilter;
    PresaleEnabled(_old?: null, _new?: null): PresaleEnabledEventFilter;
