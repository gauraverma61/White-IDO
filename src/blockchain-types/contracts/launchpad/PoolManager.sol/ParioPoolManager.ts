...
export declare namespace ParioPoolManager {
...
export interface ParioPoolManagerInterface extends utils.Interface {
  functions: {
    ...
    "setEmergencyWithdrawFees(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setEmergencyWithdrawFees",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "EmergencyWithdrawFeesChanged(address,uint256,uint256)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "EmergencyWithdrawFeesChanged"
  ): EventFragment;
...
export interface EmergencyWithdrawFeesChangedEventObject {
  pool_address: string;
  _old: BigNumber;
  _new: BigNumber;
}
export type EmergencyWithdrawFeesChangedEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  EmergencyWithdrawFeesChangedEventObject
>;

export type EmergencyWithdrawFeesChangedEventFilter =
  TypedEventFilter<EmergencyWithdrawFeesChangedEvent>;
...
export interface ParioPoolManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ParioPoolManagerInterface;
  ...
  functions: {
    ...
    getCumulativePoolInfo(
      ...
      overrides?: CallOverrides
    ): Promise<[ParioPoolManager.CumulativeLockInfoStructOutput[]]>;
    ...
    getTopPool(
      overrides?: CallOverrides
    ): Promise<[ParioPoolManager.TopPoolInfoStructOutput[]]>;
  ...
  filters: {
    ...
    "EmergencyWithdrawFeesChanged(address,uint256,uint256)"(
      pool_address?: PromiseOrValue<string> | null,
      _old?: null,
      _new?: null
    ): EmergencyWithdrawFeesChangedEventFilter;
    EmergencyWithdrawFeesChanged(
      pool_address?: PromiseOrValue<string> | null,
      _old?: null,
      _new?: null
    ): EmergencyWithdrawFeesChangedEventFilter;
