...
export interface AirdropMasterInterface extends utils.Interface {
  ...
  events: {
    ...
    "TGEUpdated(uint256,uint256,uint256)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "TGEUpdated"): EventFragment;
}
...
export interface TGEUpdatedEventObject {
  tgeBps: BigNumber;
  cycle: BigNumber;
  cycleBps: BigNumber;
}
export type TGEUpdatedEvent = TypedEvent<
  [BigNumber, BigNumber, BigNumber],
  TGEUpdatedEventObject
>;

export type TGEUpdatedEventFilter = TypedEventFilter<TGEUpdatedEvent>;
...
export interface AirdropMaster extends BaseContract {
  ...
  filters: {
    ...
    "TGEUpdated(uint256,uint256,uint256)"(
      tgeBps?: null,
      cycle?: null,
      cycleBps?: null
    ): TGEUpdatedEventFilter;
    TGEUpdated(
      tgeBps?: null,
      cycle?: null,
      cycleBps?: null
