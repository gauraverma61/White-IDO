...
export declare namespace ParioLocker {
...
export interface ParioLockerInterface extends utils.Interface {
  functions: {
...
export interface ParioLocker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ParioLockerInterface;
  ...
  functions: {
    ...
    getCumulativeLpTokenLockInfo(
      ...
      overrides?: CallOverrides
    ): Promise<[ParioLocker.CumulativeLockInfoStructOutput[]]>;
    ...
    getLockAt(
      index: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ParioLocker.LockStructOutput]>;
